...
let tar = document.querySelectorAll('.tarif__item')
console.log(tar)
for (let index = 0; index < tar.length; index++) {
	...
	element.addEventListener('click', function () {
		...
		if (window.innerWidth < 950) {
			...
			let pop = document.querySelector('.popup_popup');
...
let a = document.querySelector('.tarif__block-mobile')
a.addEventListener('click', function (e) {
	e = e.target

	if (e.classList.contains('_q')) {
		console.log(e)
		let pop = document.querySelector('.popup_popup');
		pop.classList.add('_active')
	}
